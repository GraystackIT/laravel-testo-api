...
/**
 * POST /v3/alarms — initiate an asynchronous historical alarm export.
 *
 * Request structure mirrors the measurements endpoint.
 */
class SubmitAlarmRequest extends Request implements HasBody
{
    use HasJsonBody;
