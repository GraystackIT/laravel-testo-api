...
// ──────────────────────────────────────────────────────────────────────────────
// submitEquipmentRequest  (maps to POST /v3/devices/properties)
// ──────────────────────────────────────────────────────────────────────────────

it('submits a device properties request and returns AsyncSubmitResponse', function () {
...
it('submits a device properties request with custom format', function () {
    $mockClient = new MockClient([
...
it('throws TestoApiException when device properties submit returns 401', function () {
    $mockClient = new MockClient([
...
it('throws TestoApiException when device properties submit response is missing request_uuid', function () {
    $mockClient = new MockClient([
...
// ──────────────────────────────────────────────────────────────────────────────
// checkEquipmentStatus  (maps to GET /v3/devices/properties/{uuid})
// ──────────────────────────────────────────────────────────────────────────────

it('checks device properties status and returns AsyncStatusResponse', function () {
    $mockClient = new MockClient([
...
it('throws TestoApiException when device properties status check returns 404', function () {
    $mockClient = new MockClient([
